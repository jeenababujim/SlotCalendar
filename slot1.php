...
<body>
    <div class="container" id="calendar">
        ...
        <table class="table-responsive">
            <table class="table table-borderless" >
                <thead>
                    <tr>
                        <td  colspan="1"><button id="prev" class="btn btn-link" onclick="prevWeek()"><i class="fas fa-arrow-alt-circle-left" style='font-size:32px;color:#000000;'></i></button></td>
                        <td colspan="5">
                            <h5 id="current-week"></h5>
                        </td>
                        <td  colspan="1"><button id="next" class="btn btn-link" onclick="nextWeek()"><i class="fas fa-arrow-alt-circle-right" style='font-size:32px;color:#000000;'></i></button> </td>
                    </tr>
                    <tr id="week-day"></tr>
                </thead>
        ...
        <table class="table-responsive">
            <table class="table table-borderless" style="position:relative;" id="slot" style="display: none;">
                <thead>
                    <tr>
    ...
    <!-- <form name="Appointment" id="frm" method="post"></form> -->
        <input type="text" name="selectedDate" id="selectedDate" value="">
        <input type="text" name="selectedSlot" id="selectedSlot" value="">
...
//         // Toggle the round style on click
        
//         cell.classList.remove("round-clicked");
//         cell.classList.add("round-clicked");
//     }
        ...
        $("#btnSave").click(function() {
            ...
            if ((check1) && (check2)) {
                ...
                $.ajax({
                    url: "Appointment.php",
                    method: "POST",
                    data: {selectedDate:check1,selectedSlot:check2},
                    processData: false,
                    contentType: false,
